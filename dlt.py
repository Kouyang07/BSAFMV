...
def test():
    ...
    print('3D (x, y, z) coordinates of the badminton court points:')
    xyz = [[1247.17, 435.571, 0], [1421.71, 991.575, 0], [492.734, 995.962, 0], [675.015, 438.409, 0],
           [1204.01, 435.785, 0], [1351.63, 991.906, 0], [562.762, 995.632, 0], [718.151, 438.195, 0],
           [1290.92, 574.937, 0], [629.32, 578.179, 0], [1339.84, 730.785, 0], [578.225, 734.466, 0],
           [960.072, 576.559, 0], [958.971, 732.626, 0], [1313.69, 647.482, 0], [605.535, 650.93, 0],
           [1253.4, 455.409, 0], [668.51, 458.305, 0], [1406.19, 942.156, 0], [508.934, 946.412, 0],
           [961.057, 436.99, 0], [957.128, 993.769, 0], [1312.38, 434.858, 0], [604.231, 439.222, 0]]
    print(N.asarray(xyz))

    print('2D (u, v) coordinates (in pixels) of the badminton court points:')
    uv1 = [[1247.17, 435.571],[1421.71, 991.575],[492.734, 995.962],[675.015, 438.409],[1204.01, 435.785],[1351.63, 991.906],
           [562.762, 995.632],[718.151, 438.195],[1290.92, 574.937],[629.32, 578.179],[1339.84, 730.785],[578.225, 734.466],
           [960.072, 576.559],[958.971, 732.626],[1313.69, 647.482],[605.535, 650.93],[1253.4, 455.409],[668.51, 458.305],
           [1406.19, 942.156],[508.934, 946.412],[961.057, 436.99],[957.128, 993.769],[1312.38, 434.858],[604.231, 439.222]]
    print(N.asarray(uv1))

    print('')
    print('Use the view to perform a 3D calibration of the camera with 24 points of the badminton court:')
    nd=3
    L1, err1 = DLTcalib(nd, xyz, uv1)
    print('Camera calibration parameters based on the view:')
    print(L1)
    print('Error of the calibration (in pixels):')
    print(err1)

    print('')
    print('Transform the 2D coordinate (68, 12) to its 3D position:')
    uv_test = N.array([68, 12])
    xyz_test = DLTrecon(nd, 1, L1, uv_test)
    print('The 3D position of the coordinate (68, 12) is:')
    print(xyz_test)
